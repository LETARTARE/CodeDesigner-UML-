...
void udManagePluginsDialog::OnOk(wxCommandEvent& event)
{
	...
	wxMessageBox( _("All changes will take an effect after application's restart."), wxT("CodeDesigner") );
