...
_CodeDialog::_CodeDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText1 = new wxStaticText( this, wxID_ANY, _("Name (must be valid language identifier);"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_cbMakeValid = new wxCheckBox( this, wxID_ANY, _("Make valid"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_cbInline = new wxCheckBox( m_pageAdv, wxID_ANY, _("Inline code"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_pNotebook->AddPage( m_pageEditor, _("Editor"), false );
...
_StateActionDialog::_StateActionDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText17 = new wxStaticText( m_pageAdv, wxID_ANY, _("Type:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText17->Wrap( -1 );
	advSizer->Add( m_staticText17, 0, wxTOP|wxRIGHT|wxLEFT, 5 );

	wxString m_chTypeChoices[] = { _("Entry action"), _("Exit action") };
...
_EventDialog::_EventDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText11 = new wxStaticText( m_pageAdv, wxID_ANY, _("Event type:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText11->Wrap( -1 );
	advSizer->Add( m_staticText11, 0, wxTOP|wxRIGHT|wxLEFT, 5 );

	wxString m_chEventTypeChoices[] = { _("Normal event"), _("Critical event") };
...
_ActionLinkDialog::_ActionLinkDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText1 = new wxStaticText( this, wxID_ANY, _("Link name:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText1->Wrap( -1 );
	controlSizer->Add( m_staticText1, wxGBPosition( 0, 0 ), wxGBSpan( 1, 1 ), wxTOP|wxRIGHT|wxLEFT, 5 );
	...
	originalSizer = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, _("Original code item:") ), wxHORIZONTAL );

	m_stOriginal = new wxStaticText( this, wxID_ANY, _("MyLabel"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stOriginal->Wrap( -1 );
	m_stOriginal->SetFont( wxFont( 9, 74, 90, 92, false, wxT("Sans") ) );

	originalSizer->Add( m_stOriginal, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5 );

	btnEditOrig = new wxButton( this, wxID_ANY, _("Edit original"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_pNotebook->AddPage( m_pageParametersMap, _("Call parameters"), false );
...
_ClassMemberLinkDialog::_ClassMemberLinkDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText17 = new wxStaticText( m_pageAdv, wxID_ANY, _("Access:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText17->Wrap( -1 );
	advSizer->Add( m_staticText17, 0, wxTOP|wxRIGHT|wxLEFT, 5 );
...
_EventLinkDialog::_EventLinkDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_checkBoxClearFlag = new wxCheckBox( m_pageAdv, wxID_ANY, _("Clear event flag"), wxDefaultPosition, wxDefaultSize, 0 );
	m_checkBoxClearFlag->SetToolTip( _("Clear event flag automatically") );
...
_TransitionDialog::_TransitionDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText51 = new wxStaticText( m_pageCondition, wxID_ANY, _("Condition:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText52 = new wxStaticText( m_pageCondition, wxID_ANY, _("Priority:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_pNotebook->AddPage( m_pageCondition, _("Condition"), true );
	...
	m_staticText53 = new wxStaticText( m_pageActions, wxID_ANY, _("Used actions:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	menuUsedSelectAll = new wxMenuItem( m_menuUsed, IDM_TRANS_SELECTALL, wxString( _("Select all") ) , wxEmptyString, wxITEM_NORMAL );
	m_menuUsed->Append( menuUsedSelectAll );

	wxMenuItem* menuUsedDeselectAll;
	menuUsedDeselectAll = new wxMenuItem( m_menuUsed, IDM_TRANS_DESELECTALL, wxString( _("Deselect all") ) , wxEmptyString, wxITEM_NORMAL );
	#ifdef __WXMSW__
	...
	menuUsedClearAll = new wxMenuItem( m_menuUsed, IDM_TRANS_REMOVEALL, wxString( _("Remove all") ) , wxEmptyString, wxITEM_NORMAL );
	...
	m_btnUp = new wxButton( m_pageActions, wxID_ANY, _("Up"), wxDefaultPosition, wxDefaultSize, 0 );
	operationsSizer->Add( m_btnUp, 0, wxBOTTOM|wxRIGHT|wxLEFT, 5 );

	m_btnDown = new wxButton( m_pageActions, wxID_ANY, _("Down"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText54 = new wxStaticText( m_pageActions, wxID_ANY, _("Available actions:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	menuAvailableSelectAll = new wxMenuItem( m_menuAvailable, IDM_TRANS_SELECTALLAV, wxString( _("Select all") ) , wxEmptyString, wxITEM_NORMAL );
	m_menuAvailable->Append( menuAvailableSelectAll );

	wxMenuItem* menuAvailableDeselectAll;
	menuAvailableDeselectAll = new wxMenuItem( m_menuAvailable, IDM_TRANS_DESELECTALLAV, wxString( _("Deselect all") ) , wxEmptyString, wxITEM_NORMAL );
	...
	m_pNotebook->AddPage( m_pageActions, _("Actions"), false );
...
_FinalStateDialog::_FinalStateDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText56 = new wxStaticText( m_pageAdv, wxID_ANY, _("Return value:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_btnDefault = new wxButton( m_pageAdv, wxID_ANY, _("Default"), wxDefaultPosition, wxDefaultSize, 0 );
...
_CompStateDialog::_CompStateDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_notebookActions->AddPage( m_pageEntry, _("Entry"), true );
	...
	menuUsedSelectAllExit = new wxMenuItem( m_menuUsedExit, IDM_TRANS_SELECTALL, wxString( _("Select all") ) , wxEmptyString, wxITEM_NORMAL );
	m_menuUsedExit->Append( menuUsedSelectAllExit );

	wxMenuItem* menuUsedDeselectAllExit;
	menuUsedDeselectAllExit = new wxMenuItem( m_menuUsedExit, IDM_TRANS_DESELECTALL, wxString( _("Deselect all") ) , wxEmptyString, wxITEM_NORMAL );
	#ifdef __WXMSW__
	...
	menuUsedClearAllExit = new wxMenuItem( m_menuUsedExit, IDM_TRANS_REMOVEALL, wxString( _("Remove all") ) , wxEmptyString, wxITEM_NORMAL );
	...
	m_notebookActions->AddPage( m_pageExit, _("Exit"), false );
...
_ConstructorDialog::_ConstructorDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText461 = new wxStaticText( m_pageAdv, wxID_ANY, _("Implementation:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText461->Wrap( -1 );
	advSizer->Add( m_staticText461, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );

	wxString m_chImplementationChoices[] = { _("<user-defined-code>") };
	...
	m_staticText431 = new wxStaticText( m_pageAdv, wxID_ANY, _("Function modifier:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_btnAdd = new wxButton( m_pageParams, wxID_ANY, _("Add"), wxDefaultPosition, wxDefaultSize, 0 );
	gbSizer->Add( m_btnAdd, wxGBPosition( 0, 1 ), wxGBSpan( 1, 1 ), wxALL, 5 );

	m_btnEdit = new wxButton( m_pageParams, wxID_ANY, _("Edit"), wxDefaultPosition, wxDefaultSize, 0 );
	gbSizer->Add( m_btnEdit, wxGBPosition( 1, 1 ), wxGBSpan( 1, 1 ), wxBOTTOM|wxRIGHT|wxLEFT, 5 );

	m_btnRemove = new wxButton( m_pageParams, wxID_ANY, _("Remove"), wxDefaultPosition, wxDefaultSize, 0 );
	gbSizer->Add( m_btnRemove, wxGBPosition( 2, 1 ), wxGBSpan( 1, 1 ), wxBOTTOM|wxRIGHT|wxLEFT, 5 );

	m_btnMoveUp = new wxButton( m_pageParams, wxID_ANY, _("Move up"), wxDefaultPosition, wxDefaultSize, 0 );
	gbSizer->Add( m_btnMoveUp, wxGBPosition( 3, 1 ), wxGBSpan( 1, 1 ), wxBOTTOM|wxRIGHT|wxLEFT, 5 );

	m_btnMoveDown = new wxButton( m_pageParams, wxID_ANY, _("Move down"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_pNotebook->AddPage( m_pageParams, _("Parameters"), false );
	...
	m_staticText80 = new wxStaticText( m_pageBases, wxID_ANY, _("Call parameters for base constructor:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_pNotebook->AddPage( m_pageBases, _("Base classes"), false );
	m_pageEditor = new wxPanel( m_pNotebook, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	wxBoxSizer* editorSizer;
	editorSizer = new wxBoxSizer( wxVERTICAL );
...
_RenameVirtualDialog::_RenameVirtualDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText37 = new wxStaticText( this, wxID_ANY, _("New name (must be valid identifier):"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_chbMakeValid = new wxCheckBox( this, wxID_ANY, _("Make valid"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	renameSizer = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, _("Rename also:") ), wxVERTICAL );
	...
	menuSelectAll = new wxMenuItem( m_menuCandidates, IDM_CANDIDATES_SELECTALL, wxString( _("Select all") ) , wxEmptyString, wxITEM_NORMAL );
	m_menuCandidates->Append( menuSelectAll );

	wxMenuItem* menuDeselectAll;
	menuDeselectAll = new wxMenuItem( m_menuCandidates, IDM_CANDIDATES_DESELECTALL, wxString( _("Deselect all") ) , wxEmptyString, wxITEM_NORMAL );
...
_ClassTemplateDialog::_ClassTemplateDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText43 = new wxStaticText( m_pageTempl, wxID_ANY, _("Typename:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_pNotebook->AddPage( m_pageTempl, _("Template"), true );
...
_ClassInstanceDialog::_ClassInstanceDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText40 = new wxStaticText( this, wxID_ANY, _("Instance name:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText41 = new wxStaticText( this, wxID_ANY, _("Parameters:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText42 = new wxStaticText( this, wxID_ANY, _("Type:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText42->Wrap( -1 );
	itemSizer->Add( m_staticText42, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );

	wxString m_choiceTypeChoices[] = { _("Static"), _("Dynamic") };
...
_EnumElementDialog::_EnumElementDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText11 = new wxStaticText( m_pageAdv, wxID_ANY, _("Value:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText11->Wrap( -1 );
	advSizer->Add( m_staticText11, 0, wxTOP|wxRIGHT|wxLEFT, 5 );
...
_EnumDialog::_EnumDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText11 = new wxStaticText( m_pageAdv, wxID_ANY, _("Instance name:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText11->Wrap( -1 );
	advSizer->Add( m_staticText11, 0, wxTOP|wxRIGHT|wxLEFT, 5 );
...
_ClassDialog::_ClassDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_chbGenerate = new wxCheckBox( m_pageAdv, wxID_ANY, _("Generate code"), wxDefaultPosition, wxDefaultSize, 0 );
...
_SubStateDialog::_SubStateDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_chbStoreRetVal = new wxCheckBox( m_pageAdv, wxID_ANY, _("Store return value"), wxDefaultPosition, wxDefaultSize, 0 );
	m_chbStoreRetVal->SetToolTip( _("Store value returned from managed sub diagram") );
...
_AggregationDialog::_AggregationDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_chbIncludeClass = new wxCheckBox( m_pageAdv, wxID_ANY, _("Include target class"), wxDefaultPosition, wxDefaultSize, 0 );
	advSizer->Add( m_chbIncludeClass, 0, wxALL, 5 );

	wxBoxSizer* bSizer63;
	bSizer63 = new wxBoxSizer( wxHORIZONTAL );

	m_staticText55 = new wxStaticText( m_pageAdv, wxID_ANY, _("Access:"), wxDefaultPosition, wxDefaultSize, 0 );
