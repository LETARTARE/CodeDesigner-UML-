...
void udUpdateCodeDialog::OnInit(wxInitDialogEvent& event)
{
	...
	m_staticText->SetLabel( _("Reference to '") + m_Pattern + _("' has been found in these code items:") );
...
void udUpdateCodeDialog::OnNext(wxCommandEvent& event)
{
	...
	{
		wxMessageBox( _("The end of the code preview has been reached."), wxT("CodeDesigner"), wxOK );
	}
}
...
void udUpdateCodeDialog::OnPrevious(wxCommandEvent& event)
{
	...
	{
		wxMessageBox( _("The begin of the code preview has been reached."), wxT("CodeDesigner"), wxOK );
	}
}
