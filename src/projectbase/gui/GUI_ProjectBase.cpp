...
_DiagramDialog::_DiagramDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_cbGenerate = new wxCheckBox( m_pageAdv, wxID_ANY, _("Generate code from this diagram"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText14 = new wxStaticText( m_pageGen, wxID_ANY, _("Output file (without extension):"), wxDefaultPosition, wxSize( -1,-1 ), 0 );
	...
	m_fpOutputFile = new wxFilePickerCtrl( m_pageGen, wxID_ANY, wxEmptyString, _("Select an output file"), wxT("*.*"), wxDefaultPosition, wxDefaultSize, wxFLP_SAVE|wxFLP_USE_TEXTCTRL );
	fileSizer->Add( m_fpOutputFile, 1, wxALL, 5 );

	m_btnReset = new wxButton( m_pageGen, wxID_ANY, _("Reset"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText15 = new wxStaticText( m_pageGen, wxID_ANY, _("Generator:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText15->Wrap( -1 );
	fgSizer6->Add( m_staticText15, 0, wxTOP|wxRIGHT|wxLEFT, 5 );

	m_staticText16 = new wxStaticText( m_pageGen, wxID_ANY, _("Algorithm:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_pNotebook->AddPage( m_pageGen, _("Generator"), false );
...
_FunctionDialog::_FunctionDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_chbInline = new wxCheckBox( m_pageAdv, wxID_ANY, _("Inline"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText43 = new wxStaticText( m_pageRetVal, wxID_ANY, _("Modifier:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText44 = new wxStaticText( m_pageRetVal, wxID_ANY, _("Data type:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText45 = new wxStaticText( m_pageRetVal, wxID_ANY, _("Value type:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_pNotebook->AddPage( m_pageRetVal, _("Return value"), false );
	...
	m_staticText46 = new wxStaticText( m_pageUserDataType, wxID_ANY, _("Type name:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText48 = new wxStaticText( m_pageUserDataType, wxID_ANY, _("Defined in:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText48->Wrap( -1 );
	fgSizer10->Add( m_staticText48, 0, wxALIGN_CENTER_VERTICAL|wxBOTTOM|wxRIGHT|wxLEFT, 5 );

	wxString m_chDefinitionPlaceChoices[] = { _("Built-in"), _("Editor"), _("Definition file") };
	...
	m_staticText47 = new wxStaticText( m_pageUserDataType, wxID_ANY, _("Definition file:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText47->Wrap( -1 );
	fgSizer10->Add( m_staticText47, 0, wxALIGN_CENTER_VERTICAL|wxBOTTOM|wxRIGHT|wxLEFT, 5 );

	m_fpDefinitionFile = new wxFilePickerCtrl( m_pageUserDataType, wxID_ANY, wxEmptyString, _("Select a file"), wxT("*.*"), wxDefaultPosition, wxDefaultSize, wxFLP_DEFAULT_STYLE|wxFLP_USE_TEXTCTRL );
	...
	m_pNotebook->AddPage( m_pageUserDataType, _("User return type"), false );
	...
	wxString m_chEditedFieldChoices[] = { _("Function code"), _("User-defined return type") };
...
_VariableDialog::_VariableDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText43 = new wxStaticText( m_pageAdv, wxID_ANY, _("Modifier:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText43->Wrap( -1 );
	...
	m_staticText44 = new wxStaticText( m_pageAdv, wxID_ANY, _("Data type:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText44->Wrap( -1 );
	dataTypeSizer->Add( m_staticText44, 0, wxALL, 5 );
	...
	m_staticText45 = new wxStaticText( m_pageAdv, wxID_ANY, _("Value type:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText45->Wrap( -1 );
	dataTypeSizer->Add( m_staticText45, 0, wxALL, 5 );
	...
	m_staticText431 = new wxStaticText( m_pageAdv, wxID_ANY, _("Default value:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText431->Wrap( -1 );
	...
	m_pageUserDataType->Layout();
	userdataSizer->Fit( m_pageUserDataType );
	m_pNotebook->AddPage( m_pageUserDataType, _("User-define data type"), false );
	m_pageEditor = new wxPanel( m_pNotebook, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	wxBoxSizer* editorSizer;
	editorSizer = new wxBoxSizer( wxVERTICAL );
...
_ChoiceDialog::_ChoiceDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_stextComment = new wxStaticText( this, wxID_ANY, _("Comment"), wxDefaultPosition, wxDefaultSize, 0 );
...
_UpdateCodeDialog::_UpdateCodeDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText = new wxStaticText( this, wxID_ANY, _("Reference to '' has been found in:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText->Wrap( -1 );
	...
	menuSelectAll = new wxMenuItem( m_menuChecklist, IDM_SELECT_ALL, wxString( _("SelectAll") ) , wxEmptyString, wxITEM_NORMAL );
	m_menuChecklist->Append( menuSelectAll );

	wxMenuItem* menuDeselectAll;
	menuDeselectAll = new wxMenuItem( m_menuChecklist, IDM_DESELECT_ALL, wxString( _("Deselect all") ) , wxEmptyString, wxITEM_NORMAL );
	...
	m_staticText33 = new wxStaticText( this, wxID_ANY, _("Pattern occurences:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_btnPrev = new wxButton( this, wxID_ANY, _("Previous"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_btnUpdate = new wxButton( this, wxID_OK, _("Update selected"), wxDefaultPosition, wxDefaultSize, 0 );
...
_ScopedElementDialog::_ScopedElementDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText43 = new wxStaticText( m_pageAdv, wxID_ANY, _("Access:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText43->Wrap( -1 );
	dataTypeSizer->Add( m_staticText43, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
...
_ProgressDialog::_ProgressDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_stLabel = new wxStaticText( this, wxID_ANY, _("Text"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stLabel->Wrap( -1 );
