...
void wxSFAutoLayout::InitializeAllAlgorithms()
{
	...
	RegisterLayoutAlgorithm( _("Circle"), new wxSFLayoutCircle() );
	RegisterLayoutAlgorithm( _("Horizontal Tree"), new wxSFLayoutHorizontalTree() );
	RegisterLayoutAlgorithm( _("Vertical Tree"), new wxSFLayoutVerticalTree() );
	RegisterLayoutAlgorithm( _("Mesh"), new wxSFLayoutMesh() );
}
